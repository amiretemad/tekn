...
class SendIOSNotification implements NotificationSendChannel
{
    ...
    {
        echo sprintf('Message : %s  To : %s has been sent successfully.', $message->getMessage(), $message->getTo()) . PHP_EOL;
    ...
    public function isProcessable(NotificationMessageInterface $message): bool
    {
        ...
        return $message->getNotificationDevice() === NotificationDeviceType::IOS;
    }
